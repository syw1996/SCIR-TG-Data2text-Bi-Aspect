...
def model_opts(parser):
    ...
    group.add_argument('-only_ply_level_gate', action="store_true",
                       help="""Activate only_ply_level_gate""")
...
def preprocess_opts(parser):
    ...
    group.add_argument('-train_ref_src', required=True,
                       help="Path to the training reference source data")
    group.add_argument('-train_ref_tgt', required=True,
                       help="Path to the training reference target data")
    group.add_argument('-valid_src1', required=True,
                       help="Path to the validation source data")
    group.add_argument('-valid_tgt1', required=True,
                       help="Path to the validation target data")
    group.add_argument('-valid_ref_src', required=True,
                       help="Path to the validation reference source data")
    group.add_argument('-valid_ref_tgt', required=True,
                       help="Path to the validation reference target data")
    ...
    group.add_argument('-train_ref_ptr', required=True,
                       help="Path to the training reference pointers data")
...
def finetune_argument(parser):
    parser.add_argument('-finetune_steps', type=int, required=True,
                        help='setup finetune step.')
    parser.add_argument('-ref_idxs', type=str, required=True,
                        help='reference index file path.')
    parser.add_argument('-ref_fold', type=str, required=True,
                        help='reference files fold path.')
    parser.add_argument('-mask_ptr', type=int, default=0,
                        help='reference files fold path.')
